...
public class Followers{
    ...
    public static ArrayList<Followers> UserFollowersList;
    ...
    public static ArrayList getUserFollowersList() {
        return UserFollowersList;
    }

    public static void setUserFollowersList(ArrayList userFollowersList) {
